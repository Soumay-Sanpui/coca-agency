  ...
  return (
    <div className='py-[6vw] w-screen px-[8vw] min-h-screen flex flex-col gap-[4vw] items-start justify-around'>
      ...
      <div className='flex flex-col gap-[4vw]'>
        <h1 className='font-bold text-[7vw] leading-[6vw]'>VISION INTO <br /> REALITY</h1>
        <p>Proven Strategies for High-Converting Website Copy: Techniques to<br />Optimize Your Copy for Maximum Conversions and Sales</p>
        {/* buttons */}
